 ...
 * @file math_3d.h
 *
 * @brief Math 3D v1.0 - by Stephan Soller <stephan.soller@helionweb.de> and Tobias Malmsheimer
 *
 * Licensed under the MIT license
 *
 * See: https://github.com/arkanis/single-header-file-c-libs/blob/master/math_3d.h
 *
 * A few minor changes by Emmanuel Thomas-Maurin <manu@etmsoftware.net>
 * - m4_frustum() added
 ...
 *
 * Frustum matrix
 * Similar to Android OpenGL ES 2.0 frustum matrix:
 * https://developer.android.com/reference/android/opengl/Matrix#frustumM(float[],%20int,%20float,%20float,%20float,%20float,%20float,%20float)
 *
 * NOT USED SO FAR
 */
mat4_t m4_frustum(float left, float right, float bottom, float top, float near, float far)
 ...
 * So we take the inverse of that rotation matrix and in case of a rotation
